class TabLink {
  constructor(tabElement){
    ...
    if (this.tabData === 'all' ){
     ...
     //instance of the TabCard class. Pass in a card object to the TabCard
      //class. 
  ...
  selectTab(){
    ...
    // Iterate through the NodeList removing the .active-tab
...
- In your .forEach() method's callback function, return a new 
    instance of TabLink and pass in each tab as a parameter
